const CACHE='samara-care-erp-v2.0.0';
const ASSETS=['./','./index.html','./styles.css?v=101','./app.js?v=101','./config.js?v=101','./manifest.webmanifest?v=101','./icons/icon-192.png','./icons/icon-512.png'];
